...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Process 0
    if rank in [-1, 0]:
        testloader = create_dataloader(test_path, imgsz_test, int(4), gs, opt,  # testloader
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, _, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 10:
                    ...
                    Thread(target=plot_images, args=(imgs, targets, None, f), daemon=True).start()
                    # if tb_writer:
        ...
        if rank in [-1, 0]:
            ...
            if (not opt.nosave) or (final_epoch and not opt.evolve):  # if save
                ...
                if (best_fitness == fi) and (epoch >= epochs/3*2):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[512, 2048], help='[train, test] image sizes')
