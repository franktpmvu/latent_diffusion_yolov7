...
class Dataset_Aug1_pair(data.Dataset):
    def __init__(self, folder, image_size, exts = ['jpg', 'jpeg', 'png']):
        super().__init__()
        self.folder = folder
        self.image_size = image_size
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        if dataset == 'train':
            ...
            print(folder)
            self.ds = Dataset_pair(folder,image_size)
        ...
        self.dl = cycle_pair(data.DataLoader(self.ds, batch_size = train_batch_size, shuffle=shuffle, pin_memory=True, num_workers=16, drop_last=True))
    ...
    def train(self):
        ...
        while self.step < self.train_num_steps:
            ...
            if self.step != 0 and self.step % self.save_and_sample_every == 0:
                ...
                utils.save_image(gt_img, str(self.results_folder / f'sample-gt-{milestone}.png'), nrow=6)
    ...
    def paper_showing_diffusion_images_cover_page(self):
        ...
        for i in range(5):
            batches = self.batch_size
            og_img_1,og_img_2 = next(self.dl)
            og_img_1 = og_img_1.cuda()
            og_img_2 = og_img_2.cuda()
